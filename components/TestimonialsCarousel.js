  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div
          className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-to-br from-gray-100 to-gray-400 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: '2s' }}
        ></div>
        <div
          className="absolute top-1/2 left-1/4 w-24 h-24 bg-gradient-to-br from-white to-gray-200 rounded-full blur-2xl animate-pulse"
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col items-center mt-12 space-y-6">
          {/* Progress Bar */}
          <div
            className="w-64 h-1 bg-white/10 rounded-full overflow-hidden border border-white/5"
            style={{
