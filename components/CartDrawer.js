...
export default function CartDrawer({ open, onClose }) {
  ...
  return (
    <div className={`fixed inset-0 z-50 transition-opacity duration-300 ${open ? 'visible opacity-100' : 'invisible opacity-0'}`} aria-hidden={!open}>
      {/* Backdrop */}
      ...
      >
        ...
        <div className="absolute inset-0 opacity-5 md:hidden">
          ...
          <div className="absolute bottom-1/4 left-1/3 w-24 h-24 bg-gradient-to-br from-gray-300/40 to-white/40 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '4.5s' }}></div>
        </div>
        ...
        <div className="flex items-center justify-between px-6 h-16 border-b border-white/10 relative z-10">
          <button
            ...
            style={{
              animation: open ? `enhancedFadeIn 0.5s cubic-bezier(0.23, 1, 0.32, 1) forwards` : 'none',
        ...
        <div 
          ...
          style={{
            animation: open ? `enhancedSlideIn 0.45s cubic-bezier(0.23, 1, 0.32, 1) forwards` : 'none',
            animationDelay: '0.2s',
            opacity: 0,
          ...
          {cart.length === 0 ? (
            <div className="text-center py-8">
              ...
              >
                ...
                <p className="text-white/60 mb-4 text-lg font-light">Ваша корзина пуста</p>
                <p className="text-sm text-white/40 mb-6">Рекомендуемые продукты:</p>
              </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-white/60 text-xs mb-2">{product.description}</p>
                        <div className="flex items-center gap-2">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <div className="text-2xl font-bold gradient-text">{getTotal().toLocaleString()} ₽</div>
              </div>
              <button
