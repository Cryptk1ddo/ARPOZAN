        ...
        <>
          ...
          >
            ...
            <div className="absolute inset-0 opacity-5 md:hidden">
              ...
              <div className="absolute bottom-8 right-10 w-28 h-28 bg-gradient-to-br from-gray-200 to-gray-400 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
              <div className="absolute top-1/3 right-1/4 w-20 h-20 bg-gradient-to-br from-white/50 to-gray-300/50 rounded-full blur-xl animate-pulse" style={{ animationDelay: '3s' }}></div>
              <div className="absolute bottom-1/3 left-1/4 w-24 h-24 bg-gradient-to-br from-white/30 to-gray-200/30 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '4.5s' }}></div>
            </div>
            ...
            <div className="flex items-center justify-between px-6 h-16 border-b border-white/10 md:hidden">
              <button
                ...
                style={{
                  animation: isOpen ? `enhancedFadeIn 0.5s cubic-bezier(0.23, 1, 0.32, 1) forwards` : 'none',
            ...
            <div className="p-6 md:p-6">
              ...
              <div 
                ...
                style={{
                  animation: isOpen ? `enhancedSlideIn 0.45s cubic-bezier(0.23, 1, 0.32, 1) forwards` : 'none',
              ...
              >
                ...
                <input
                  ...
                  style={{ 
                    fontSize: '16px',
                    background: 'linear-gradient(135deg, rgba(248, 248, 248, 0.08) 0%, rgba(248, 248, 248, 0.04) 100%)',
                    boxShadow: '0 4px 16px rgba(0, 0, 0, 0.3), inset 0 1px 0 rgba(248, 248, 248, 0.05)'
                  }}
                />
                {query && (
                  <button
              ...
              <AnimatePresence>
                {results.length > 0 && (
                  <motion.div
                    ...
                    style={{
                      animation: isOpen ? `enhancedSlideIn 0.4s cubic-bezier(0.23, 1, 0.32, 1) forwards` : 'none',
                      animationDelay: '0.2s',
                      opacity: 0,
                    ...
                    <div className="space-y-3 md:space-y-2">
                      {results.map((product, idx) => (
                        <Link
                          ...
                          style={{
                            background: 'linear-gradient(135deg, rgba(248, 248, 248, 0.03) 0%, rgba(248, 248, 248, 0.01) 100%)',
                            boxShadow: '0 4px 16px rgba(0, 0, 0, 0.2), inset 0 1px 0 rgba(248, 248, 248, 0.03)',
                            animation: isOpen ? `enhancedSlideIn 0.4s cubic-bezier(0.23, 1, 0.32, 1) forwards` : 'none',
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                              <h3 className="text-white font-semibold text-base md:text-sm leading-tight mb-1 group-hover:text-blue-400 transition-colors duration-200">{product.name}</h3>
              ...
              {query && results.length === 0 && (
                <motion.div
                  ...
                  style={{
                    animation: isOpen ? `enhancedFadeIn 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards` : 'none',
                    animationDelay: '0.4s',
                    opacity: 0
                  }}
                >
              ...
              {!query && (
                <motion.div
                  ...
                  className="mt-6"
                  style={{
                    animation: isOpen ? `enhancedSlideIn 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards` : 'none',
                    animationDelay: '0.5s',
                    opacity: 0,
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-3">
                    {['Мака', 'Йохимбин', 'Цинк', 'Тонгкат Али', 'Энергия', 'Либидо'].map((term, idx) => (
                      <button
                        key={term}
