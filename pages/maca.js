...
export default function Maca() {
  ...
  const components = {
    maca: {
      ...
      content: "Это уникальные жирные кислоты, которые содержатся только в маке. Они действуют как природные регуляторы, стимулируя эндокринную систему и повышая выработку гормонов, ответственных за либидо и энергию, не вмешиваясь напрямую в гормональный фон."
    },
    amino: {
      title: "Аминокислоты",
      content: "Мака богата аргинином — аминокислотой, которая улучшает кровообращение за счет расширения сосудов. Это напрямую влияет на качество эрекции и повышает физическую выносливость во время интимной близости."
    },
    vitamins: {
      title: "Витамины и Минералы",
      content: "Высокое содержание витаминов группы B, витамина C, а также цинка и йода, поддерживает общий тонус организма, снижает утомляемость и укрепляет нервную систему, что крайне важно для здоровой сексуальной функции."
    }
  }
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Природный бустер либидо от ARPOZAN. Мака перуанская для повышения энергии и сексуальной активности." />
      </Head>
            ...
            <section id="product" className="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-[25px]">
              ...
              <div className="flex flex-col justify-center py-16 px-4 sm:px-8" id="purchase-section">
                <div className="max-w-[450px] w-full">
                  ...
                  <h1 ref={titleRef} className="text-4xl lg:text-5xl font-bold gradient-text mt-2">Мака перуанская</h1>
                  <p className="mt-2 text-gray-400 text-lg">Природный бустер либидо</p>

                  <p className="mt-6 text-gray-400">Растение из высокогорных районов Перу, которое веками использовали мужчины для поддержания силы и сексуальной энергии.</p>
                        ...
                        >
                          <div className="flex flex-col items-center gap-1 sm:gap-2">
                            <svg className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              ...
                              {key === 'focus' && <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />}
                            </svg>
                          ...
                          <div className="mt-4 pl-8 border-t border-gray-700/50 pt-4">
                            ...
                            <div className="grid grid-cols-3 gap-2 text-sm">
                              <div>
                                ...
                                <label htmlFor="freq4" className="block text-center py-2 px-4 rounded-lg border border-gray-600 peer-checked:border-gray-300 peer-checked:bg-gray-500/10 cursor-pointer transition">4 недели</label>
                              </div>
                              <div>
                                <input type="radio" id="freq6" name="frequency" value="6" className="hidden peer" defaultChecked />
                                <label htmlFor="freq6" className="block text-center py-2 px-4 rounded-lg border border-gray-600 peer-checked:border-gray-300 peer-checked:bg-gray-500/10 cursor-pointer transition">6 недель</label>
                              </div>
                              <div>
                                <input type="radio" id="freq8" name="frequency" value="8" className="hidden peer" />
                                <label htmlFor="freq8" className="block text-center py-2 px-4 rounded-lg border border-gray-600 peer-checked:border-gray-300 peer-checked:bg-gray-500/10 cursor-pointer transition">8 недель</label>
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <section id="components" className="my-16 py-12 reveal">
              <div className="text-center">
                ...
                <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-400">Узнайте, что делает нашу маку такой эффективной.</p>
            ...
            <section className="my-16 py-12 reveal">
              <div className="text-center">
                ...
                <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-400">Мы предлагаем не просто маку, а гарантированное качество и эффективность.</p>
                <div className="mt-12 max-w-4xl mx-auto">
                  <div className="grid grid-cols-3 gap-px bg-gray-700 rounded-lg overflow-hidden glass-card border-0">
                    ...
                    <div className="p-4 text-left font-bold bg-black/40">Чистота</div>
              ...
              <div className="container mx-auto px-6 lg:px-12">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div>
                    ...
                    <p className="mt-4 text-lg text-gray-400">Перуанская мака содержит уникальные биологически активные вещества — макамиды и макаены. Научные исследования показывают, что именно эти соединения отвечают за повышение либидо и улучшение сексуальной функции.</p>
                    <p className="mt-4 text-gray-400">Они действуют на эндокринную систему, помогая организму естественным образом регулировать гормональный баланс, что приводит к увеличению энергии, выносливости и полового влечения без использования синтетических стимуляторов.</p>
                  </div>
                </div>
              </div>
            </section>
