...
export default function MacaNew() {
  const [currentImageIndex, setCurrentImageIndex] = useState(0)
  const [selectedPlan, setSelectedPlan] = useState('one-time')
  const [quantity, setQuantity] = useState(1)
  const [activeBenefit, setActiveBenefit] = useState('energy')
  const [activeComponent, setActiveComponent] = useState('alkaloids')
  ...
  const benefits = {
    ...
    balance: "Восстанавливает гормональный баланс",
    stress: "Снижает уровень стресса и улучшает сон"
  }

  const components = {
    alkaloids: {
      title: "Мака-алкалоиды",
      content: "Это уникальные биологически активные соединения, которые содержатся только в корне маки. Они стимулируют выработку энергии естественным путем, не вмешиваясь напрямую в гормональную систему."
    },
    glycosides: {
      title: "Гликозиды",
    ...
    vitamins: {
      ...
      content: "Природные витамины и минералы, которые обладают адаптогенными свойствами. Они помогают организму лучше справляться со стрессом, улучшают сон и повышают общую резистентность к негативным факторам."
    }
  }
  ...
  return (
    <>
      <Head>
        <title>Мака Перуанская Premium - ARPOZAN</title>
        <meta name="description" content="Мака Перуанская Premium для энергии и гормонального баланса от ARPOZAN. Природный адаптоген из Перу." />
      </Head>
            ...
            <section id="product" className="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-[25px]">
              <div className="lg:sticky lg:top-[81px] h-[60vh] lg:h-[calc(100vh-81px)]">
                <div className="relative reveal w-full h-full p-8 lg:p-16 flex items-center justify-center">
                  <img
                    ...
                    alt="Изображение продукта Мака Перуанская Premium"
              ...
              <div className="flex flex-col justify-center py-16 px-4 sm:px-8" id="purchase-section">
                <div className="max-w-[450px] w-full">
                  ...
                  <h1 ref={titleRef} className="text-4xl lg:text-5xl font-bold gradient-text mt-2">Мака Перуанская Premium</h1>
                  <p className="mt-2 text-gray-400 text-lg">Природный адаптоген для энергии</p>

                  <p className="mt-6 text-gray-400">Мощный корень из высокогорья Перу, который веками использовали инки для поддержания энергии и гормонального баланса.</p>
                        ...
                        >
                          <div className="flex flex-col items-center gap-2">
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              ...
                              {key === 'balance' && <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z" />}
                              {key === 'stress' && <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />}
                            </svg>
                            {key === 'energy' && 'Энергия'}
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <section id="components" className="my-16 py-12 reveal">
              <div className="text-center">
                <h2 className="text-3xl font-bold gradient-text">Ключевые компоненты энергии</h2>
                <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-400">Узнайте, что делает нашу мака такой эффективной.</p>
                <div className="mt-12 max-w-4xl mx-auto">
                  <div className="flex flex-col md:flex-row gap-4 justify-center mb-8">
                    {Object.entries(components).map(([key, data], index) => (
                      ...
                      >
                        {key === 'alkaloids' && 'Мака-алкалоиды'}
                        {key === 'glycosides' && 'Гликозиды'}
                        {key === 'vitamins' && 'Витамины'}
                      </button>
                    ))}
                  </div>
            ...
            <section className="my-16 py-12 reveal">
              <div className="text-center">
                ...
                <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-400">Мы предлагаем не просто мака, а гарантированное качество и эффективность.</p>
                <div className="mt-12 max-w-4xl mx-auto">
                  <div className="grid grid-cols-3 gap-px bg-gray-700 rounded-lg overflow-hidden glass-card border-0">
                    ...
                    <div className="bg-black/50 p-4 font-bold gradient-text">ARPOZAN Мака</div>
                    <div className="bg-black/50 p-4 font-bold text-gray-400">Обычная Мака</div>
            ...
            <section className="mb-16 text-center reveal">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 max-w-4xl mx-auto">
                ...
                <div className="flex flex-col items-center p-6 glass-card rounded-lg">
                  ...
                  <p className="text-gray-400 mt-2">Регулярный прием для поддержания энергии.</p>
                </div>
                <div className="flex flex-col items-center p-6 glass-card rounded-lg">
                  <span className="text-2xl font-bold text-yellow-400">3</span>
                  <h3 className="text-xl font-bold">Почувствуйте прилив сил</h3>
                  <p className="text-gray-400 mt-2">Увеличение энергии и улучшение самочувствия.</p>
                </div>
              </div>
            </section>
              ...
              <div className="container mx-auto px-6 lg:px-12">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  <div className="glass-card rounded-lg p-4">
                    <img src="/assets/imgs/Maka peruvian.png" alt="Научное исследование Мака Перуанская" className="rounded-md w-full max-h-[500px] object-contain" />
                  </div>
                  <div>
                    <h2 className="text-3xl font-bold gradient-text">Научный подход к вашей энергии</h2>
                    <p className="mt-4 text-lg text-gray-400">Мака содержит мака-алкалоиды — уникальные биологически активные соединения, которые стимулируют естественную выработку энергии.</p>
                    <p className="mt-4 text-gray-400">Клинические исследования подтверждают эффективность маки в повышении уровня энергии, улучшении физической формы и восстановлении гормонального баланса у мужчин и женщин.</p>
                  </div>
                </div>
              </div>
            </section>
              ...
              <div className="col-span-12 md:col-span-8 mt-8 md:mt-0">
                <div className="space-y-4">
                  ...
                  <details className="glass-card rounded-lg p-4">
                    ...
                    <div className="mt-3 text-gray-400">
                      <p>Да, мака хорошо сочетается с цинком, витамином D и другими адаптогенами. Однако, для составления индивидуальной схемы лучше проконсультироваться со специалистом.</p>
                    </div>
                  </details>
                  <details className="glass-card rounded-lg p-4">
                    <summary className="flex justify-between items-center cursor-pointer font-semibold text-lg">
                    ...
                    <div className="mt-3 text-gray-400">
                      <p>Первые результаты обычно заметны через 1-2 недели регулярного приёма. Эффект накопительный.</p>
                    </div>
                  </details>
                </div>
              </div>
