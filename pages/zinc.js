...
export default function Zinc() {
  ...
  const benefits = {
    testosterone:
      'Поддержка высокого уровня тестостерона, главного мужского гормона.',
    immunity: 'Крепкий иммунитет и защита организма от вирусов и бактерий.',
    recovery:
      'Ускоренное заживление тканей и восстановление после физических нагрузок.',
  ...
  const components = {
    bioavailability: {
      ...
      content:
        'Пиколинат — это форма цинка, связанная с пиколиновой кислотой. Организм человека легко распознает эту кислоту, что позволяет минералу усваиваться практически полностью, в отличие от оксида или сульфата, которые часто выводятся, не принеся пользы.',
    },
    safety: {
      title: 'Безопасность для ЖКТ',
      content:
        'Благодаря своей органической форме, пиколинат цинка не вызывает раздражения желудка и побочных эффектов, которые могут возникать при приеме других, более дешевых форм минерала.',
    },
    effectiveness: {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Цинк пиколинат для тестостерона и иммунитета от ARPOZAN. Натуральная форма цинка для мужского здоровья."
        />
      </Head>
            ...
            >
              ...
              >
                <div className="max-w-[450px] w-full">
                  ...
                  <h1
                    ref={titleRef}
                    className="text-3xl sm:text-4xl lg:text-5xl font-bold gradient-text mt-2"
                  >
                    Цинк пиколинат
                  </h1>
                  <p className="mt-2 text-gray-400 text-base sm:text-lg">
                    Для тестостерона и иммунитета
                  </p>

                  <p className="mt-6 text-gray-400">
                    Высокобюодоступная форма цинка, которая поддерживает мужской
                    гормональный баланс и укрепляет защитные силы организма.
                  </p>
                          ...
                          <div className="mt-4 pl-8 border-t border-gray-700/50 pt-4">
                            ...
                            <div className="grid grid-cols-3 gap-1 sm:gap-2 text-xs sm:text-sm">
                              <div>
                                ...
                                <label
                                  htmlFor="freq4"
                                  className="block text-center py-2 px-2 sm:px-4 rounded-lg border border-gray-600 peer-checked:border-gray-300 peer-checked:bg-gray-500/10 cursor-pointer transition text-xs sm:text-sm"
                                >
                                  4 недели
                                </label>
                              </div>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <section id="components" className="my-16 py-12 reveal">
              <div className="text-center">
                ...
                <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-400">
                  Узнайте, что делает наш цинк пиколинат таким эффективным.
                </p>
            ...
            <section className="my-16 py-12 reveal">
              <div className="text-center">
                ...
                <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-400">
                  Мы предлагаем не просто цинк, а гарантированное качество и
                  эффективность.
                </p>
                <div className="mt-12 max-w-4xl mx-auto">
                  <div className="grid grid-cols-3 gap-px bg-gray-700 rounded-lg overflow-hidden glass-card border-0">
                    <div className="bg-black/50 p-2 sm:p-4 font-bold text-xs sm:text-sm">
                      Параметр
                    </div>
                    <div className="bg-black/50 p-2 sm:p-4 font-bold gradient-text text-xs sm:text-sm">
                      ARPOZAN Цинк
                    </div>
                    <div className="bg-black/50 p-2 sm:p-4 font-bold text-gray-400 text-xs sm:text-sm">
                      Обычный Цинк
                    </div>

                    <div className="p-2 sm:p-4 text-left font-bold bg-black/30 text-xs sm:text-sm">
                      Форма
                    </div>
                    ...
                    <div className="p-2 sm:p-4 text-left font-bold bg-black/40 text-xs sm:text-sm">
                      Усвояемость
                    </div>
                    ...
                    <div className="p-2 sm:p-4 text-left font-semibold bg-black/40 text-xs sm:text-sm">
                      Гарантия
                    </div>
                    <div className="p-2 sm:p-4 bg-black/40 flex items-center justify-center">
                      <svg
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mt-8 sm:mt-12 max-w-4xl mx-auto">
                <div className="flex flex-col items-center p-4 sm:p-6 glass-card rounded-lg">
                  ...
                  <p className="text-gray-400 mt-2 text-sm sm:text-base">
                    Лучше всего во время еды для лучшего усвоения.
                  </p>
                </div>
                <div className="flex flex-col items-center p-4 sm:p-6 glass-card rounded-lg">
                  <span className="text-xl sm:text-2xl font-bold text-gray-300">
                  ...
                  <p className="text-gray-400 mt-2 text-sm sm:text-base">
                    Регулярный прием для поддержания уровня цинка.
                  </p>
                </div>
                <div className="flex flex-col items-center p-4 sm:p-6 glass-card rounded-lg">
                  <span className="text-xl sm:text-2xl font-bold text-gray-300">
                  ...
                  <p className="text-gray-400 mt-2 text-sm sm:text-base">
                    Улучшение иммунитета и гормонального баланса.
                  </p>
                </div>
              </div>
            </section>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div>
                    ...
                    <p className="mt-4 text-lg text-gray-400">
                      Цинк пиколинат — это высокобюодоступная форма цинка,
                      которая эффективно усваивается организмом и поддерживает
                      нормальный уровень тестостерона.
                    </p>
                    <p className="mt-4 text-gray-400">
                      Клинические исследования подтверждают, что пиколинат цинка
                      в 2-3 раза лучше усваивается по сравнению с традиционными
                      формами, что делает его идеальным выбором для поддержания
                      мужского здоровья.
                    </p>
                  </div>
                </div>
